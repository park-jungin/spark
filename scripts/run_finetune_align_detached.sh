...
KNOWLEDGE_ROUTER_TARGET_KEEP_RATIO="${KNOWLEDGE_ROUTER_TARGET_KEEP_RATIO:-0.7}"
KNOWLEDGE_ROUTER_MIN_KEEP_TOKENS="${KNOWLEDGE_ROUTER_MIN_KEEP_TOKENS:-250}"
...
KNOWLEDGE_ROUTER_BUDGET_LOSS_COEFF="${KNOWLEDGE_ROUTER_BUDGET_LOSS_COEFF:-0.1}"
KNOWLEDGE_ROUTER_ENTROPY_LOSS_COEFF="${KNOWLEDGE_ROUTER_ENTROPY_LOSS_COEFF:-0.1}"
...
echo "  ROUTER : enabled=${USE_KNOWLEDGE_ROUTER}, keep_ratio=${KNOWLEDGE_ROUTER_TARGET_KEEP_RATIO}, warmup=${KNOWLEDGE_ROUTER_WARMUP_STEPS}, hard=${KNOWLEDGE_ROUTER_HARD_ROUTING}"
